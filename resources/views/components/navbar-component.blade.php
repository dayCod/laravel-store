<div class="navbar bg-white">
    <div class="flex-1">
      <a class="btn btn-ghost normal-case text-xl text-gray-600">Laravel Store</a>
    </div>
    <div class="flex-none gap-2">
      <div class="form-control">
        <input type="text" placeholder="Search" class="input input-bordered bg-white" />
      </div>
      ...
      <div class="dropdown dropdown-end">
        ...
        <ul tabindex="0" class="mt-3 p-2 shadow menu menu-compact dropdown-content bg-white rounded-box w-52">
          <li>
            <a class="text-gray-600">Profile</a>
          </li>
          <li>
            <a class="text-gray-600">Settings</a>
          </li>
          <li>
